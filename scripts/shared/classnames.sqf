...
if ( isNil "opfor_sentry") then { opfor_sentry = "O_T_Soldier_F"; };
if ( isNil "opfor_rifleman") then { opfor_rifleman = "O_T_Soldier_F"; };
if ( isNil "opfor_grenadier") then { opfor_grenadier = "O_T_Soldier_GL_F"; };
if ( isNil "opfor_squad_leader") then { opfor_squad_leader = "O_T_Soldier_SL_F"; };
if ( isNil "opfor_team_leader") then { opfor_team_leader = "O_T_Soldier_TL_F"; };
if ( isNil "opfor_marksman") then { opfor_marksman = "O_T_Soldier_M_F"; };
if ( isNil "opfor_machinegunner") then { opfor_machinegunner = "O_T_Soldier_AR_F"; };
if ( isNil "opfor_heavygunner") then { opfor_heavygunner = "O_T_Soldier_AR_F"; };
if ( isNil "opfor_medic") then { opfor_medic = "O_T_Medic_F"; };
if ( isNil "opfor_rpg") then { opfor_rpg = "O_T_Soldier_LAT_F"; };
if ( isNil "opfor_at") then { opfor_at = "O_T_Soldier_AT_F"; };
if ( isNil "opfor_aa") then { opfor_aa = "O_T_Soldier_AA_F"; };
if ( isNil "opfor_officer") then { opfor_officer = "O_T_Officer_F"; };
if ( isNil "opfor_sharpshooter") then { opfor_sharpshooter = "O_T_ghillie_tna_F"; };
if ( isNil "opfor_sniper") then { opfor_sniper = "O_T_Sniper_F"; };
if ( isNil "opfor_engineer") then { opfor_engineer = "O_T_Engineer_F"; };
if ( isNil "opfor_paratrooper") then { opfor_paratrooper = "O_T_Soldier_PG_F"; };
if ( isNil "viper_rifleman") then { viper_rifleman = "O_V_Soldier_hex_F"; };
if ( isNil "viper_teamleader") then { viper_teamleader = "O_V_Soldier_TL_hex_F"; };
if ( isNil "viper_medic") then { viper_medic = "O_V_Soldier_Medic_hex_F"; };
if ( isNil "viper_marksman") then { viper_marksman = "O_V_Soldier_M_hex_F"; };
if ( isNil "viper_AT") then { viper_AT = "O_V_Soldier_LAT_hex_F"; };
...
FCLIB_blacklisted_from_arsenal = [
...
opfor_squad_8_infkillers = [viper_teamleader,viper_teamleader,viper_marksman,viper_marksman,viper_medic,viper_AT,viper_rifleman,viper_rifleman];
...
FCLIB_intel_chair = "Land_CampingChair_V2_F";
FCLIB_intel_file = "Land_File1_F";
FCLIB_intel_laptop = "Land_Laptop_device_F";
FCLIB_ignore_colisions_when_building = [
